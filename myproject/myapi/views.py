...
def fetch_drug_maps(request):
    ...
    def get_drug_names(engine):
        try:
            ...
            raise
    sql_username, sql_password, sql_hostname, sql_port, sql_database_name = load_auth()
    sql_password_2 = urllib.parse.quote_plus(sql_password)
    engine = connect_db(sql_username, sql_password_2, sql_hostname, sql_database_name)
